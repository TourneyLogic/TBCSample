<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Title="TOURNEY LOGIC: TBC 2.1 QuickStart Tutorial: NCAA March Madness Bracket" %>
...
<h4>
            <strong>2005 NCAA Men's Divison 1 Basketball Tournament Bracket Example</strong></h4>
            This example shows how to use Tourney Bracket Control to build the bracket for the NCAA "March Madness" Tournament.<br />
        <br />
        
    <tl:Bracket runat="server" ID="Bracket1" DisplayMode="EditPicksMode"  RoundWidth="150" Font-Size="x-small" OnBracketCreated="Bracket1_BracketCreated" RoundTextStyle-Font-Bold="True" ><Competitors>
