<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Title="TOURNEY LOGIC: TBC 2.1 QuickStart Tutorial: Validating Results" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h4>
        <strong>Validating Results</strong></h4>
    This example shows how to disable submit buttons from being enabled until all of
    the results have been selected in the bracket.&nbsp; We use this in the
    <a href="http://www.tourneylogic.com/Products/PoolManager/default.aspx">Tourney Pool
        Manager</a> when users are submitting their picks.<br />
    <br />

    <script language="javascript">
			function DoEnableFinish(blnEnable){
				
				if(blnEnable){
					document.all.ctl00$ContentPlaceHolder1$SubmitBottom.disabled = false;
					document.all.ctl00$ContentPlaceHolder1$SubmitTop.disabled = false;
				} else {
					document.all.ctl00$ContentPlaceHolder1$SubmitBottom.disabled = true;
					document.all.ctl00$ContentPlaceHolder1$SubmitTop.disabled = true;
				}
			}
    </script>

    <asp:Button ID="SubmitTop" runat="server" Text="Submit Results" OnClick="Submit_Click" /><br />
    <br />
    <tl:Bracket runat="server" ID="Bracket1" DisplayMode="EditPicksMode" RoundWidth="150" Font-Size="x-Small" OnBracketCreated="Bracket1_BracketCreated"
        RoundTextStyle-Font-Bold="True" ClientSideEvents-OnBracketChange="DoEnableFinish"><Competitors>
...
<tl:BracketCompetitor ID="Austin15" CompetitorName="Eastern Ky." SeedNumber="15"></tl:BracketCompetitor>
    ...
    <br />
    <asp:Button ID="SubmitBottom" runat="server" Text="Submit Results" OnClick="Submit_Click" /><br />
    <br />
